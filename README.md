...
<!-- Add a short GIF once recorded, e.g. ![demo](docs/demo.gif) -->
_Demo GIF coming soon — it shows the same page side by side: masked in the share, readable on your own screen._
